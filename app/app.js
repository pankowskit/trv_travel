var appCfg ={
    navRoutes:[        
        ...
        {navItem:true, path:"/destinations",name:"Destinations",view:"app/views/destinations.html"},
        {navItem:true, path:"/travel",name:"Travel",view:"app/views/travel.html"},
        {navItem:true, path:"/promos",name:"Promos",view:"app/views/promos.html"},
